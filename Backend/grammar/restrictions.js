...
const check_repeatedAttrs = (arr, attrs, el_name) => (Object.keys(attrs).length == arr.length) ? attrs : `O elemento <${el_name}> não pode possuir atributos repetidos!`
...
function check_constrFacetAttrs(name, arr) {
    ...
    if (typeof attrs == "string") return {error: attrs}
